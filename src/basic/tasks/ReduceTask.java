...
public interface ReduceTask extends Serializable {
	 ...
	 * 
	 * @param key
	 *            The key currently being reduced.
	 * @param values
	 *            An {@link Iterator} over all of the values for the specified
	 *            key.
	 * @param emitter
	 *            The {@link Emitter} to use to emit the final key/value pair
	 *            for the specified key.
	 * 
	 * @throws IOException
	 *             If an I/O error occurs (to be handled by the framework).
	 */
